...
export default function ProductDetails() {
    ...
    return (
        <>
            <div className='text-white flex px-50 gap-50 mt-20 '>
                <div className='flex gap-5 '>
                    <img className='w-150 h-150 rounded-lg ' src={selectedProduct.image} alt="error" />


                    <Wishlist />

                    <div className='mt-117 flex gap-2 flex-col relative right-20'>
                        <button className='border w-15 h-15 rounded-lg font-bold text-lg'>1</button>
                        <button className='border w-15 h-15 rounded-lg font-bold text-lg'>2</button>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <div className='flex gap-3 mt-3 mb-4'>
                            <p className='font-medium pt-1.5 text-gray-400'>{selectedProduct.price}</p>
                            <h1 className='text-2xl font-bold text-red-500'>{selectedProduct.offer}</h1>
                        </div>
                    </div>
                    <hr className=' '></hr>
                    <div className='mt-7'>
                        <h2 className='font-bold  '>Description</h2>
                        <p className='text-sm w-100 mt-3'>{selectedProduct.description}</p>
                    </div>
                    <div>
                        <p className='mt-5 font-bold'>Flavour Name:</p>
                        <div className='flex gap-5 text-center mt-3'>
                            <div className='border w-26 h-10 rounded-md pt-2 text-sm bg-red-500 font-medium '>Watermelon</div>
                            <div className='border w-26 h-10 rounded-md pt-2 text-sm bg-red-500 font-medium '>Kiwi Kick</div>
                            <div className='border w-26 h-10 rounded-md pt-2 text-sm bg-red-500 font-medium '>Tropical Tango</div>
                            <div className='border w-26 h-10 rounded-md pt-2 text-sm bg-red-500 font-medium '>Fruit fusion</div>
                        </div>
                    </div>
                    <div>
            ...
            <div>
                <div className='text-white flex justify-between px-30 mt-20 mb-10'>
            ...
            <div>
                <h1 className='font-bold text-2xl'>Related Products</h1>
                <div>
                    <div className='flex justify-between px-30 mt-10 mb-15'>
            ...
            <div className='text-white'>
                <div className='flex justify-between px-30 mt-20 mb-10'>
